...
```{r,eval=T}
intdata<-as.matrix(read.csv("data/InteractionIntensity.csv",row.names = 1))
...
writeLines(readLines(paste("model/",mod_name,".R",sep="")))
  ...
  #MCMC options
      model<-jags(data=Dat,parameters.to.save=ParsStage,model.file=paste("model/",mod_name,".jags",sep=""),n.thin=10,n.iter=50000,n.burnin=46000,n.chains=2,DIC=F)
    return(model)
}
