...
zero_count<-expand.grid(Plant=unique(sumf$Plant),Site=unique(sumf$Site),Month=unique(sumf$Month),Year=unique(sumf$Year),n=0)
...
zero_count<-zero_count %>% anti_join(sumf,by=c("Plant","Site","Month","Year")) %>% inner_join(mean_ele)
